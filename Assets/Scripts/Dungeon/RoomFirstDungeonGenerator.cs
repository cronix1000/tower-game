...
namespace Dungeon
{
    public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
    {
        ...
        private void CreateRooms()
        {
            ...
            // Get random starting position for the random walk
            ...
            foreach (var VARIABLE in floor)
            {
                
            }

            MapManager.Instance.rooms = rooms;
            MapManager.Instance.floorTiles = floor;
        ...
        private HashSet<Vector2Int> CreateSimpleRooms(List<BoundsInt> roomsList)
        {
            ...
            {
                Room room = new Room(roomBounds.xMax - roomBounds.xMin, roomBounds.yMax - roomBounds.yMin, new Vector2Int(roomBounds.x, roomBounds.y));
